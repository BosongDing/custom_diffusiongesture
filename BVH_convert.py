...
def convert_bvh_to_direction_vectors(bvh_file, output_file=None, exclude_lower_body=True, start_frame=0, end_frame=None):
    ...
    if exclude_lower_body:
        ...
        exclude_joints = [
            ...
            'RightUpLeg', 'RightLeg', 'RightFoot', 'RightToeBase','LeftForeFoot','LeftToeBase',
            'Hips', 'Spine',"pCube4"  # Exclude all spines below Spine2
        ]
...
if __name__ == "__main__":
    # Example usage
    # bvh_file_path = '/home/bsd/cospeech/DiffGesture/data/trinity/allRec/Recording_001.bvh'  # Replace with your BVH file path
    # output_file_path = 'converted_motion.npz'  # Output file path

    # # Convert BVH to direction vectors
    # bvh_data = parse_bvh(bvh_file_path)
    # visualize_original_bvh(bvh_data, frame_idx=0)
    for bvh_file_path in os.listdir("/home/bsd/cospeech/DiffGesture/data/trinity/allTestMotion"):
        if not bvh_file_path.endswith('.bvh'):
            continue
        bvh_file_path = os.path.join("/home/bsd/cospeech/DiffGesture/data/trinity/allTestMotion", bvh_file_path)
    ...
    # print(f"Processed {joint_positions.shape[0]} frames")
    ...
    # print(f"Direction vectors shape: {dir_vectors.shape}")

    # # Visualize the first frame
    
    # visualize_skeleton(joint_positions, connections, frame_idx=0)
    # visualize_direction_vectors(joint_positions, dir_vectors, connections, frame_idx=0)