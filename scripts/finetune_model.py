...
class AdaptedPoseDiffusion(nn.Module):
    ...
    def load_pretrained_weights(self, checkpoint_path, freeze_audio=True):
...
def main():
    ...
    parser.add_argument('--output_dir', default='./output/finetune_beat_trinitytest', help='Output directory for checkpoints')
    ...
    args_finetune.checkpoint = "/home/bsd/cospeech/DiffGesture/output/train_diffusion_trinity/pose_diffusion_trinity_checkpoint_200.bin"
    ...
    train_dataset = LMDBDataset(dataset_path="/home/bsd/cospeech/DiffGesture/data/trinity_all_test_cache")
